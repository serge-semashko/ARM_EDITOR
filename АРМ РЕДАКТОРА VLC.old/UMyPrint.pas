...
begin
  ...
  if frMyPrint.cbDataPrint.ItemIndex = 0 then
    cv.TextOut(MaketOptions.X5, hght, 'Комментарий')
  else
    cv.TextOut(MaketOptions.X5, hght, 'Текст песни');
end;
...
begin
  ...
  for i := 1 to cnt do
    cbTypePrint.Items.Add('Устройство ' + inttostr(i));
