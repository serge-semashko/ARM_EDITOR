...
Type
  ...
  TButtonImage = (im123,imaddsong,imbook,imcut,imcopy,impaste1,impaste2,imdel,imdown,
                  imprint,imshift,imtrash,imtrim,imundo,imup,imuser,imfastback,
                  imback,imforward,imfastforward,imstartpos,impred,imnext,imendpos,
                  imleft, imright,implus,imminus,imsort,imsave,impause,imimport,
                  imevntrht, imnone);
...
Var
    btnspanelusers, btnspanelsample : TBTNSPanel;
...
//Панель Настройки программы
   btnspanelsample:=tbtnspanel.Create;
   btnspanelsample.BackGround:=ProgrammColor;
   btnspanelsample.Left:=25;
   btnspanelsample.Right:=25;
   btnspanelsample.Top:=10;
   btnspanelsample.Bottom:=20;
   btnspanelsample.HeightRow:=35;

   RowTemp:=btnspanelsample.AddRow;
   btnspanelsample.Rows[RowTemp].AutoSize:=true;
   BtnTemp:=btnspanelsample.Rows[RowTemp].AddButton('Кнопки',imnone);
   btnspanelsample.Rows[RowTemp].Btns[BtnTemp].Width:=300;
   btnspanelsample.Rows[RowTemp].Btns[BtnTemp].Font.Color:=clWhite;
   btnspanelsample.Rows[RowTemp].Btns[BtnTemp].ColorBorder:=clWhite;
   btnspanelsample.Rows[RowTemp].Btns[BtnTemp].Hint:='Строка подсказки.';
   btnspanelsample.Rows[RowTemp].Btns[BtnTemp].HintShow:=true;
   btnspanelsample.Rows[RowTemp].Btns[BtnTemp].FontHint.Size:=8;

//Панель Пользователей
   btnspanelusers:=tbtnspanel.Create;
   btnspanelusers.BackGround:=ProgrammColor;
   btnspanelusers.Left:=25;
   btnspanelusers.Right:=25;
   btnspanelusers.Top:=10;
   btnspanelusers.Bottom:=20;
   btnspanelusers.HeightRow:=35;

   RowTemp:=btnspanelusers.AddRow;
   btnspanelusers.Rows[RowTemp].AutoSize:=true;
   BtnTemp:=btnspanelusers.Rows[RowTemp].AddButton('Добавить',imnone);
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Width:=300;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Font.Color:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].ColorBorder:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Hint:='Добавить нового пользователя [CTRL+N].';
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].HintShow:=true;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].FontHint.Size:=8;

   RowTemp:=btnspanelusers.AddRow;
   btnspanelusers.Rows[RowTemp].AutoSize:=true;
   BtnTemp:=btnspanelusers.Rows[RowTemp].AddButton('Редактировать',imnone);
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Width:=300;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Font.Color:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].ColorBorder:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Hint:='Редактировать данные пользователя [CTRL+R].';
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].HintShow:=true;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].FontHint.Size:=8;

   RowTemp:=btnspanelusers.AddRow;
   btnspanelusers.Rows[RowTemp].AutoSize:=true;
   BtnTemp:=btnspanelusers.Rows[RowTemp].AddButton('Удалить',imnone);
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Width:=300;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Font.Color:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].ColorBorder:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Hint:='Удалить пользователя [DEL].';
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].HintShow:=true;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].FontHint.Size:=8;
...
// Панель управляющих кнопок окна подготовки
   ...
   //btnspanel1.BackGround;                // TButtonImage = (im123,imaddsong,imbook,imcut,imcopy,impaste1,impaste2,imdel,imdown,
    ...
    btnspanel1.Rows[RowTemp].Btns[BtnTemp].Hint:='Установить начало следующего события';
...
// Панель кнопок проект
    ...
    BtnTemp:=pnlprojects.Rows[RowTemp].AddButton('Удалить', imtrash);
    ...
    BtnTemp:=pnlprojects.Rows[RowTemp].AddButton('Сортировать', imsort);
...
// Понель кнопок управления проектом
   ...
   BtnTemp:=pnlprojcntl.Rows[RowTemp].AddButton('Tайм-линия', implus);
   pnlprojcntl.Rows[RowTemp].Btns[BtnTemp].Hint:='Добавить тайм-линию';

   BtnTemp:=pnlprojcntl.Rows[RowTemp].AddButton('Тайм-линия', imminus);
   pnlprojcntl.Rows[RowTemp].Btns[BtnTemp].Hint:='Удалить тайм-линию';

   RowTemp:=pnlprojcntl.AddRow;
   BtnTemp:=pnlprojcntl.Rows[RowTemp].AddButton('Резерв', imnone);
   ...
   RowTemp:=pnlprojcntl.AddRow;
   BtnTemp:=pnlprojcntl.Rows[RowTemp].AddButton('Сохранить', imsave);
   pnlprojcntl.Rows[RowTemp].Btns[BtnTemp].Hint:='Сохранить сделанные изменения';
   BtnTemp:=pnlprojcntl.Rows[RowTemp].AddButton('Сортировать', imsort);
...
// Понель кнопок управления клипами
   ...
   BtnTemp:=pnlbtnsclips.Rows[RowTemp].AddButton('Загрузить в плей-лист', impaste2);
