...
begin
  ...
  if Result.Button<>btnone then begin
     ...
     btprocent : if mode<>play then begin
...
begin
  ...
  if Editing  then cv.Font.Color:=FontColor  else cv.Font.Color:=SmoothColor(Color,128);
  cv.Font.Name:=FontName;
  if FontBold then cv.Font.Style:=cv.Font.Style + [fsBold] else cv.Font.Style:=cv.Font.Style - [fsBold];
  if FontBold then cv.Font.Style:=cv.Font.Style + [fsItalic] else cv.Font.Style:=cv.Font.Style - [fsItalic];
  if FontBold then cv.Font.Style:=cv.Font.Style + [fsUnderline] else cv.Font.Style:=cv.Font.Style - [fsUnderline];
