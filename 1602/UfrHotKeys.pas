...
begin
  ...
  AddString('4|322|Загрузить данные из файла на редактируемую тайм-линию|CTRL+SHIFT+R');
  AddString('4|323|Проверить времена запуска клипов в текущем плей-листе|CTRL+T');
