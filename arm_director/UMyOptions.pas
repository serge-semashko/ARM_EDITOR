...
begin
  ...
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Допуск сигнала синхронизации',inttostr(SynchDelay),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Время жизни проекта по умолчанию (дни)',inttostr(DeltaDateDelete),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
...
begin
  ...
  s:=trim(Groups[APos].getdata('Допуск сигнала синхронизации'));
