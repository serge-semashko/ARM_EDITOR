...
begin
  ...
  InfoProtocol.Options[6].Text:=INFOName1;
  InfoProtocol.SetData(6,INFOText1);
  InfoProtocol.Options[7].Text:=INFOName2;
  InfoProtocol.SetData(7,INFOText1);
  InfoProtocol.Options[8].Text:=INFOName3;
  InfoProtocol.SetData(8,INFOText1);
end;
...
initialization
  ...
  InfoWEB.Add('Тайм код воспроизведения:','00:00:00:00');
  InfoWEB.Add('Текущий кадр:','');
  InfoWEB.Add('Количество событий:','');
  InfoWEB.Add('Текущее событие:','');
