...
uses umain, ucommon, uinitforms, ugrid, uactplaylist, umyfiles;
...
begin
  ...
  with FPlayLists do begin
    ...
    for i:=0 to lst.Count-1 do begin
      psi := findclipposition(Form1.GridClips, lst.Strings[i]);
      if psi>0 then begin
