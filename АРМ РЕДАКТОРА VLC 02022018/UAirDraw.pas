...
begin
  ...
  try
    addVariableToJson('BackGround', CTHTML(ColorToRgb(BackGround)));
    addVariableToJson('ForeGround', CTHTML(ColorToRgb(ForeGround)));
    addVariableToJson('Interval', inttostr(Interval));
    addVariableToJson('fsize', inttostr(TLParameters.FrameSize));
    addVariableToJson('sf5', CTHTML(ColorToRgb(SmoothColor(ForeGround, 5))));
    addVariableToJson('sb5', CTHTML(SmoothColor(BackGround, 5)));
    addVariableToJson('sct25', CTHTML(ColorToRgb(SmoothColor(ColorTimeline, 25))));
    addVariableToJson('sct56', CTHTML(ColorToRgb(SmoothColor(ColorTimeline, 56))));

    addVariableToJson('eTop', inttostr(REvent.Top));
    addVariableToJson('eLeft', inttostr(REvent.Left));
    addVariableToJson('eRight', inttostr(REvent.Right));
    addVariableToJson('eBottom', inttostr(REvent.Bottom));

    addVariableToJson('nTop', inttostr(RNumber.Top));
    addVariableToJson('nLeft', inttostr(RNumber.Left));
    addVariableToJson('nRight', inttostr(RNumber.Right));
    addVariableToJson('nBottom', inttostr(RNumber.Bottom));

    addVariableToJson('oTop', inttostr(ROrder.Top));
    addVariableToJson('oLeft', inttostr(ROrder.Left));
    addVariableToJson('oRight', inttostr(ROrder.Right));
    addVariableToJson('oBottom', inttostr(ROrder.Bottom));

    addVariableToJson('sTop', inttostr(RSecond.Top));
    addVariableToJson('sLeft', inttostr(RSecond.Left));
    addVariableToJson('sRight', inttostr(RSecond.Right));
    addVariableToJson('sBottom', inttostr(RSecond.Bottom));

    addVariableToJson('ColorTimeline', CTHTML(ColorToRgb(ColorTimeline)));
    addVariableToJson('ColorEvent', CTHTML(ColorToRgb(ColorEvent)));
    addVariableToJson('Number', inttostr(Number));
    addVariableToJson('Dev', inttostr(Dev));
    addVariableToJson('Start', inttostr(Start));
    addVariableToJson('Finish', inttostr(Finish));
    addVariableToJson('Duration', inttostr(Duration));
    addVariableToJson('Mix', inttostr(Mix));
    addVariableToJson('Text', Text);
    addVariableToJson('Top', inttostr(Rect.Top));
    addVariableToJson('Left', inttostr(Rect.Left));
    addVariableToJson('Right', inttostr(Rect.Right));
    addVariableToJson('Bottom', inttostr(Rect.Bottom));
  except
    on E: Exception do
...
begin
  try
    ...
    begin
      ...
      if txt <> '' then
        if txt[1] = '#' then
          cv.Font.Color := ProgrammCommentColor;
      cv.Font.Name := ProgrammFontName;
...
//  Rect: Trect;
//  addVariableToJson('Number', inttostr(Number));
//  addVariableToJson('ForeGround', inttostr(Number));
//  addVariableToJson('Curr', inttostr(Interval));
//  addVariableToJson('next', inttostr(TLParameters.FrameSize));
//  addVariableToJson('Text', CTHTML(ColorToRgb(SmoothColor(ForeGround, 5))));
//  addVariableToJson('Color', CTHTML(SmoothColor(BackGround, 5)));
//  addVariableToJson('rTop', inttostr(Rect.Top));
//  addVariableToJson('rLeft', inttostr(Rect.Left));
//  addVariableToJson('rRight', inttostr(Rect.Right));
//  addVariableToJson('rBottom', inttostr(Rect.Bottom));
end;
