...
begin
  try
    ...
    try
      Form1.Panel5.Height := ini.ReadInteger('PROJECTS', 'HeihtGrid',
        Form1.Panel5.Height);
      ...
      GridMainFontColor := ini.ReadInteger('GRIDS', 'GridMainFontColor',
        GridMainFontColor);
      ...
      DefaultTextColor := ini.ReadInteger('TLS', 'DefaultTextColor',
        DefaultTextColor);
      Layer2FontColor := ini.ReadInteger('TLS', 'Layer2FontColor',
        Layer2FontColor);
      Layer2FontSize := ini.ReadInteger('TLS', 'Layer2FontSize',
        Layer2FontSize);
