...
begin
  try
    ...
    begin
      ...
      lbPLComment.Caption := (objects[0, ARow] as TGridRows).MyCells[3]
        .ReadPhrase('Comment');
    end; // with
  except
    on E: Exception do
...
begin
  try
    ...
    begin
      if trim((Form1.GridClips.objects[0, i] as TGridRows).MyCells[3]
        .ReadPhrase('ClipID')) = trim(ClipID) then
      begin
        result := i;
        WriteLog('MAIN', 'Uplaylists.findclipposition ClipID=' + ClipID +
          ' Position=' + inttostr(i));
        ...
        begin
          ...
          begin
            ...
            begin
              ...
              (Form1.GridClips.objects[0, ps] as TGridRows)
      ...
      try
        ...
        begin
          ...
          begin
            ...
            WriteLog('MAIN', 'Uplaylists.findclipposition Clip=' + clp +
              ' ClipID=' + clpid);
          end;
        end;
      finally
