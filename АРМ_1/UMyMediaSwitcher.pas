...
begin
  ...
  if Select1 then cv.Brush.Color:=SmoothColor(Color,24) else cv.Brush.Color:=Color;
  ...
  if Select = 0 then cv.Brush.Color:=ColorSelect else cv.Brush.Color:=ColorUnselect;
  cv.Pen.Width:=1;
  cv.Ellipse(rt);
  cv.Pen.Width:=2;
  ...
  cv.Brush.Style:=bsSolid;
  if Select2 then cv.Brush.Color:=SmoothColor(Color,24) else cv.Brush.Color:=Color;
  //cv.Pen.Color := PenColor;
  cv.Pen.Width := 2;
  ...
  if Select = 1 then cv.Brush.Color:=ColorSelect else cv.Brush.Color:=ColorUnselect;
  cv.Pen.Width:=1;
  cv.Ellipse(rt);
  cv.Pen.Width:=2;
