...
type
  ...
  //процедура, занимающа€с€ опросом порта
    Procedure QueryPort;
  protected
...
//совсем не об€зательные переменые, используемые дл€ "украшени€" приложени€
...
Var
  DCB: TDCB;         //структура дл€ хранени€ настроек порта
  CT: TCommTimeouts; //стркутура дл€ хранени€ тайм-аутов
Begin {InitPort}
  ...
  DCB.Parity:=NoParity;           // нет контрол€ четности
