...
// Панель кнопок проект
    ...
    pnlprojects.Rows[RowTemp].Btns[BtnTemp].Hint:='Сохранить сделанные изменения';

// Понель кнопок управления проектом
   pnlprojcntl:=TBTNSPanel.Create;
   pnlprojcntl.Top:=10;
   pnlprojcntl.Bottom:=5;
   pnlprojcntl.Left:=30;
   pnlprojcntl.Right:=30;
   ...
   RowTemp:=pnlprojcntl.AddRow;
   BtnTemp:=pnlprojcntl.Rows[RowTemp].AddButton('Редактировать тайм-линию', imbook);
