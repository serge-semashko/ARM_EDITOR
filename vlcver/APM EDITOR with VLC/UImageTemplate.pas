...
begin
  If opendialog1.Execute then begin
     ...
     MyRect.Draw(Layer1.Canvas);
     WorkDirGRTemplate:=FGRTemplate.OpenDialog1.InitialDir;
  end;
end;
...
begin
  ...
  if CRow=-1 then begin
    ...
    nm := pathtemplates + '\' + createunicumname + '.jpeg';
    SaveToJpegFile(nm);
    ...
    (Form1.GridLists.Objects[0,CRow] as TGridRows).MyCells[1].LoadJpeg(pathtemplates + '\' + CurrFilename
