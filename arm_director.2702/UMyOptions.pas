...
begin
  ...
  Groups[ARow].clear;
  ps := 20;
  if InputWithoutUsers then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Вход без пароля',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  ...
  if MakeLogging then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Включить логирование',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Глубина буффера UNDO',inttostr(DepthUNDO),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Отклонение сигнала синхронизации (msec)',inttostr(SynchDelay),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Время жизни проекта по умолчанию (дней)',inttostr(DeltaDateDelete),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Смещение номера события',inttostr(PrintEventShift),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Шаг перемещения колеса мыши (кадры)',inttostr(StepMouseWheel),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
...
//  WorkDirKeyLayouts : string = '';
  ...
  Groups[ARow].clear;
  ps := 20;
  Groups[ARow].adddata('Цвет окна программы',IntToStr(ProgrammColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя шрифта',ProgrammFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта',inttostr(ProgrammFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Высота шрифта меню и информации',inttostr(MTFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта',inttostr(ProgrammFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет поля редактирования',IntToStr(ProgrammEditColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя шрифта поля редактирования',ProgrammEditFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта поля редактирования',inttostr(ProgrammEditFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта поля редактирования',IntToStr(ProgrammEditFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  //  ProgrammCommentColor : tcolor = clYellow;
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта кнопки',inttostr(ProgrammBtnFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя шрифта информации о кнопке',ProgrammHintBtnFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта информации о кнопке',IntToStr(ProgrammHintBTNSFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта подсказки о кнопке',inttostr(ProgrammHintBTNSFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
...
//Основные параметры вспомогательных форм
  ...
  Groups[ARow].clear;
  ps := 20;
  Groups[ARow].adddata('Цвет формы',IntToStr(FormsColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя шрифта',FormsFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта',inttostr(FormsFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер вспомоготельного шрифта',inttostr(FormsSmallFont),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта',inttostr(FormsFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет поля редактирования',IntToStr(FormsEditColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя шрифта поля редактирования',FormsEditFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта поля редактирования',inttostr(FormsEditFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта поля редактирования',IntToStr(FormsEditFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
...
//Основные цвета таблиц
  ...
  Groups[ARow].clear;
  ps := 20;
  Groups[ARow].adddata('Цвет фона таблицы',IntToStr(GridBackGround),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
//  ps:=ps + FrMyOptions.ComboBox1.Height;
...
//  Groups[ARow].adddata('Цвет основного шрифта',IntToStr(GridMainFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет четных строк таблицы',IntToStr(GridColorRow1),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет нечетных строк таблицы',IntToStr(GridColorRow2),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет выбранной строки таблицы',IntToStr(GridColorSelection),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта предупреждения',IntToStr(PhraseErrorColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта загруженного клипа',IntToStr(PhrasePlayColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет выбранного элемента ячейки',IntToStr(MyCellColorTrue),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет не выбранного элемента ячейки',IntToStr(MyCellColorFalse),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет элемента выбранного шаблона',IntToStr(MyCellColorSelect),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
...
//Шрифты таблиц
  ...
  ps:=20;
  Groups[ARow].adddata('Имя шрифта заголовка',GridTitleFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта заголовка',IntToStr(GridTitleFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер шрифта заголовка',IntToStr(GridTitleFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=8 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridTitleFontBold then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Толстый шрифт заголовка',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridTitleFontItalic then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Наклонный шрифт заголовка',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridTitleFontUnderline then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Подчеркнутый шрифт заголовка',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя основного шрифта',GridFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет основного шрифта',IntToStr(GridFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер основного шрифта',IntToStr(GridFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=7 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridFontBold then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Толстый основной шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridFontItalic then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Наклонный основной шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridFontUnderline then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Подчеркнутый основной шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
//
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя дополнительного шрифта',GridSubFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет дополнительного шрифта',IntToStr(GridSubFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер дополнительного шрифта',IntToStr(GridSubFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=6 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridSubFontBold then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Толстый дополнительный шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridSubFontItalic then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Наклонный дополнительный шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if GridSubFontUnderline then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Подчеркнутый дополнительный шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
...
//размеры таблиц
  ...
  //ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список плей-листов высота заголовка',IntToStr(PLHeightTitle),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список плей-листов высота ячейки',IntToStr(PLHeightRow),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список плей-листов отступ сверху 1-ой строки',IntToStr(PLRowsTop),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список плей-листов высота строки',IntToStr(PLRowsHeight),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список плей-листов интервал между строками',IntToStr(PLRowsInterval),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список клипов высота заголовка',IntToStr(ClipsHeightTitle),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список клипов высота ячейки',IntToStr(ClipsHeightRow),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список клипов отступ сверху 1-ой строки',IntToStr(ClipsRowsTop),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список клипов высота строки',IntToStr(ClipsRowsHeight),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Список клипов интервал между строками',IntToStr(ClipsRowsInterval),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
...
//Основные параметры Тайм-линий
  ...
  ps:=20;
  Groups[ARow].adddata('Цвет заднего фона',IntToStr(TLBackGround),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет переднего фона',IntToStr(TLZoneNamesColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Имя основного шрифта',TLZoneNamesFontName,tomFontName,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет основного шрифта',IntToStr(TLZoneNamesFontColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта под курсором',IntToStr(TLZoneFontColorSelect),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Размер основного шрифта',IntToStr(TLZoneNamesFontSize),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  for i:=7 to 32 do Groups[ARow].AddVariant(Groups[ARow].Count-1,inttostr(i));

  ps:=ps + FrMyOptions.ComboBox1.Height;
  if TLZoneNamesFontBold then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Толстый основной шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');

  ps:=ps + FrMyOptions.ComboBox1.Height;
  if TLZoneNamesFontItalic then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Наклонный основной шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');

  ps:=ps + FrMyOptions.ComboBox1.Height;
  if TLZoneNamesFontUnderline then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Подчеркнутый основной шрифт',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');
  ...
  ps:=ps + FrMyOptions.ComboBox1.Height;
  if TLZoneEditFontBold then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Толстый шрифт редакт. тайм-линия',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');

  ps:=ps + FrMyOptions.ComboBox1.Height;
  if TLZoneEditFontItalic then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Наклонный шрифт редакт. тайм-линия',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');

  ps:=ps + FrMyOptions.ComboBox1.Height;
  if TLZoneEditFontUnderline then strdt:='Да' else strdt:='Нет';
  Groups[ARow].adddata('Подчеркнутый шрифт редакт. тайм-линия',strdt,tomBoolean,10,ps,300,FrMyOptions.ComboBox1.Height);
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Да');
  Groups[ARow].AddVariant(Groups[ARow].Count-1,'Нет');

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет статуса 1',IntToStr(StatusColor[0]),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет статуса 2',IntToStr(StatusColor[1]),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет статуса 3',IntToStr(StatusColor[2]),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет статуса 4',IntToStr(StatusColor[3]),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет статуса 5',IntToStr(StatusColor[4]),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Максим. кол-во тайм-линий',IntToStr(TLMaxCount),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Макс. кол-во тайм-линий устройств',IntToStr(TLMaxDevice),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Макс. кол-во текстовых тайм-линий',IntToStr(TLMaxText),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Макс. кол-во медиа тайм-линий',IntToStr(TLMaxMedia),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);

  ARow:=Add; //7
  Groups[ARow].clear;

  ps:=20;
  Groups[ARow].adddata('Хронометраж пустого клипа (кадры)',inttostr(DefaultClipDuration),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Кол-во кадров до события',inttostr(TLPreroll),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Кол-во кадров после события',inttostr(TLPostroll),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Кол-во кадров вспышки',inttostr(TLFlashDuration),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет курсора НТК',IntToStr(StartColorCursor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет курсора КТК',IntToStr(EndColorCursor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  //ps:=ps + FrMyOptions.ComboBox1.Height;
  ...
  ps:=20;
  Groups[ARow].adddata('Количество отображаемых событий',IntToStr(RowsEvents),tomInteger,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет заднего фона зоны событий',IntToStr(AirBackGround),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет перднего фона зоны событий',IntToStr(AirForeGround),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет события',IntToStr(AirColorTimeline),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);

  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет фона зоны устройств',IntToStr(DevBackGround),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет линии тайм-кода',IntToStr(TimeForeGround),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет секундных отсчетов',IntToStr(TimeSecondColor),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Цвет шрифта комментария',IntToStr(AirFontComment),tomColor,10,ps,300,FrMyOptions.ComboBox1.Height);
...
//Основные параметры печати
  ...
  Groups[ARow].adddata('Левое поле',FloatToStr(PrintSpaceLeft),tomfloat,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Верхнее поле',FloatToStr(PrintSpaceTop),tomfloat,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Правое поле',FloatToStr(PrintSpaceRight),tomfloat,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Нижнее поле',FloatToStr(PrintSpaceBottom),tomfloat,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Верхний колонтитул',FloatToStr(PrintHeadLineTop),tomfloat,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Нижний колонтитул',FloatToStr(PrintHeadLineBottom),tomfloat,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название первого столбца',PrintCol1,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название второго столбца',PrintCol2,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название третьего столбца',PrintCol3,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название четвертого столбца',PrintCol4,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название пятого столбца',PrintCol5,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название шестого столбца вар.1',PrintCol61,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Название шестого столбца вар.2',PrintCol62,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
  ps:=ps + FrMyOptions.ComboBox1.Height;
  Groups[ARow].adddata('Поле название устройства',PrintDeviceName,tomstring,10,ps,300,FrMyOptions.ComboBox1.Height);
...
begin
  APos:=0;
  if trim(Groups[APos].getdata('Вход без пароля'))='Да'
    then InputWithoutUsers:=true else InputWithoutUsers:=false;

  if trim(Groups[APos].getdata('Включить логирование'))='Да'
...
//==============================================================================
  ...
  if trim(Groups[APos].getdata('Толстый шрифт заголовка'))='Да'
    then GridTitleFontBold:=true else GridTitleFontBold:=false;
  if trim(Groups[APos].getdata('Наклонный шрифт заголовка'))='Да'
    then GridTitleFontItalic:=true else GridTitleFontItalic:=false;
  if trim(Groups[APos].getdata('Подчеркнутый шрифт заголовка'))='Да'
  ...
  if trim(Groups[APos].getdata('Толстый основной шрифт'))='Да'
    then GridFontBold :=true else GridFontBold :=false;
  if trim(Groups[APos].getdata('Наклонный основной шрифт'))='Да'
    then GridFontItalic:=true else GridFontItalic:=false;
  if trim(Groups[APos].getdata('Подчеркнутый основной шрифт'))='Да'
  ...
  if trim(Groups[APos].getdata('Толстый дополнительный шрифт'))='Да'
    then GridSubFontBold :=true else GridSubFontBold :=false;
  if trim(Groups[APos].getdata('Наклонный дополнительный шрифт'))='Да'
    then GridSubFontItalic:=true else GridSubFontItalic:=false;
  if trim(Groups[APos].getdata('Подчеркнутый дополнительный шрифт'))='Да'
...
//==============================================================================
  ...
  s:=trim(Groups[APos].getdata('Список плей-листов отступ сверху 1-ой строки'));
...
//==============================================================================
  ...
  if trim(Groups[APos].getdata('Толстый шрифт редакт. тайм-линия'))='Да'
