...
begin
  ...
  with Form1 do begin
    ...
    PanelStartWindow.Height:=25*11 + 10;
    ...
    for i:=0 to btnstartpnl.Count-1 do begin
      btnstartpnl.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to btnstartpnl.Rows[i].Count-1 do begin
...
begin
  ...
  with Form1 do begin
    ...
    if airbackground=airforeground then begin
      MyPanelAir.AirEvents.ForeGround:=SmoothColor(airbackground,12);
      MyPanelAir.AirEvents.CurrEvent.ForeGround := SmoothColor(AirBackGround, 12);
      MyPanelAir.AirEvents.CurrTime.ForeGround := SmoothColor(AirBackGround, 12);
      MyPanelAir.AirEvents.CurrEvent.ColorTimeline := SmoothColor(AirBackGround, 48);
      for i:=0 to MyPanelAir.AirEvents.Count-1
        do MyPanelAir.AirEvents.Events[i].ColorTimeline := SmoothColor(AirBackGround, 48);
    end else begin
      ...
      for i:=0 to MyPanelAir.AirEvents.Count-1
        do MyPanelAir.AirEvents.Events[i].ColorTimeline := AirColorTimeline;
    end;
...
//Рисуем управляющие кнопки
    ...
    for i:=0 to btnspanel1.Count-1 do begin
      btnspanel1.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to btnspanel1.Rows[i].Count-1 do begin
        btnspanel1.Rows[i].Btns[j].Color:=ProgrammColor;
        btnspanel1.Rows[i].Btns[j].UpdateColorBitmap(btnspanel1.Rows[i].Btns[j].Font.Color,ProgrammFontColor);
    ...
    for i:=0 to btnsctlleft.Count-1 do begin
      btnsctlleft.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to btnsctlleft.Rows[i].Count-1 do begin
        btnsctlleft.Rows[i].Btns[j].BackGround:=ProgrammColor;
        btnsctlleft.Rows[i].Btns[j].Color:=ProgrammColor;
        btnsctlleft.Rows[i].Btns[j].UpdateColorBitmap(btnsctlleft.Rows[i].Btns[j].Font.Color,ProgrammFontColor);
    ...
    for i:=0 to btnsctlright.Count-1 do begin
      btnsctlright.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to btnsctlright.Rows[i].Count-1 do begin
        btnsctlright.Rows[i].Btns[j].Color:=ProgrammColor;
        btnsctlright.Rows[i].Btns[j].BackGround:=ProgrammColor;
        btnsctlright.Rows[i].Btns[j].UpdateColorBitmap(btnsctlright.Rows[i].Btns[j].Font.Color,ProgrammFontColor);
        ...
        btnsctlright.Rows[i].Btns[j].FontHint.Color:=ProgrammHintBTNSFontColor;
    ...
    for i:=0 to btnstexttl.Count-1 do begin
      btnstexttl.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to btnstexttl.Rows[i].Count-1 do begin
        btnstexttl.Rows[i].Btns[j].Color:=ProgrammColor;
        btnstexttl.Rows[i].Btns[j].BackGround:=ProgrammColor;
        btnstexttl.Rows[i].Btns[j].UpdateColorBitmap(btnstexttl.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
    ...
    if cmp then initgrid(GridGRTemplate, RowGridListGR, Panel14.Width);
    ...
    for i:=0 to btnsmediatl.Count-1 do begin
      btnsmediatl.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to btnsmediatl.Rows[i].Count-1 do begin
        btnsmediatl.Rows[i].Btns[j].Color:=ProgrammColor;
        btnsmediatl.Rows[i].Btns[j].BackGround:=ProgrammColor;
        btnsmediatl.Rows[i].Btns[j].UpdateColorBitmap(btnsmediatl.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
...
//Устанавливаем параметры элементов панели по умолчанию
    ...
    for i:=0 to pnlprojects.Count-1 do begin
      pnlprojects.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to pnlprojects.Rows[i].Count-1 do begin
        pnlprojects.Rows[i].Btns[j].Color:=ProgrammColor;
        pnlprojects.Rows[i].Btns[j].UpdateColorBitmap(pnlprojects.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
    ...
    for i:=0 to pnlprojcntl.Count-1 do begin
      pnlprojcntl.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to pnlprojcntl.Rows[i].Count-1 do begin
        pnlprojcntl.Rows[i].Btns[j].Color:=ProgrammColor;
        pnlprojcntl.Rows[i].Btns[j].UpdateColorBitmap(pnlprojcntl.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
    ...
    for i:=0 to pnlplaylsts.Count-1 do begin
      pnlplaylsts.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to pnlplaylsts.Rows[i].Count-1 do begin
        pnlplaylsts.Rows[i].Btns[j].Color:=ProgrammColor;
        pnlplaylsts.Rows[i].Btns[j].UpdateColorBitmap(pnlplaylsts.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
...
begin
  ...
  with form1 do begin
    ...
    for i := sbPredClip.Glyph.Canvas.ClipRect.Left to sbPredClip.Glyph.Canvas.ClipRect.Right-1
    do for j := sbPredClip.Glyph.Canvas.ClipRect.Top to sbPredClip.Glyph.Canvas.ClipRect.Bottom-1
         do if sbPredClip.Glyph.Canvas.Pixels[i ,j]=OldProgrammFontColor
              then sbPredClip.Glyph.Canvas.Pixels[i ,j]:=ProgrammFontColor;

    for i := sbNextClip.Glyph.Canvas.ClipRect.Left to sbNextClip.Glyph.Canvas.ClipRect.Right-1
    do for j := sbNextClip.Glyph.Canvas.ClipRect.Top to sbNextClip.Glyph.Canvas.ClipRect.Bottom-1
         do if sbNextClip.Glyph.Canvas.Pixels[i ,j]=OldProgrammFontColor
              then sbNextClip.Glyph.Canvas.Pixels[i ,j]:=ProgrammFontColor;

    for i := sbMainMenu.Glyph.Canvas.ClipRect.Left to sbMainMenu.Glyph.Canvas.ClipRect.Right-1
    do for j := sbMainMenu.Glyph.Canvas.ClipRect.Top to sbMainMenu.Glyph.Canvas.ClipRect.Bottom-1
         do if sbMainMenu.Glyph.Canvas.Pixels[i ,j]=OldProgrammFontColor
              then sbMainMenu.Glyph.Canvas.Pixels[i ,j]:=ProgrammFontColor;

    for i := sbSinhronization.Glyph.Canvas.ClipRect.Left to sbSinhronization.Glyph.Canvas.ClipRect.Right-1
    do for j := sbSinhronization.Glyph.Canvas.ClipRect.Top to sbSinhronization.Glyph.Canvas.ClipRect.Bottom-1
         do if sbSinhronization.Glyph.Canvas.Pixels[i ,j]=OldProgrammFontColor
              then sbSinhronization.Glyph.Canvas.Pixels[i ,j]:=ProgrammFontColor;

    for i := SpeedButton2.Glyph.Canvas.ClipRect.Left to SpeedButton2.Glyph.Canvas.ClipRect.Right-1
    do for j := SpeedButton2.Glyph.Canvas.ClipRect.Top to SpeedButton2.Glyph.Canvas.ClipRect.Bottom-1
         do if SpeedButton2.Glyph.Canvas.Pixels[i ,j]=OldProgrammFontColor
              then SpeedButton2.Glyph.Canvas.Pixels[i ,j]:=ProgrammFontColor;
...
begin
  ...
  with form1 do begin
    ...
    if GridColorRow1=GridColorRow2 then begin
...
begin
  ...
  with Form1 do begin
    ...
    pnClpFindStr.Left:=gridclips.Left+gridclips.ColWidths[0]+gridclips.ColWidths[1]
                       +gridclips.ColWidths[2]+ps1;
    ...
    if ClpText=nil then ClpText := TFindImg.Create(imgClpFindStr.Canvas, 'Исполнитель');
    if ClpTime=nil then ClpTime := TFindImg.Create(imgClpFindTime.Canvas, 'Время старта');
    ...
    for i:=0 to pnlbtnsclips.Count-1 do begin
      pnlbtnsclips.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to pnlbtnsclips.Rows[i].Count-1 do begin
        pnlbtnsclips.Rows[i].Btns[j].Color:=ProgrammColor;
        pnlbtnsclips.Rows[i].Btns[j].UpdateColorBitmap(pnlbtnsclips.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
        ...
        pnlbtnsclips.Rows[i].Btns[j].FontHint.Color:=ProgrammHintBTNSFontColor;
...
begin
  ...
  with Form1 do begin
    ...
    pnAPlFindStr.Left:=gridactplaylist.Left+gridactplaylist.ColWidths[0]+gridactplaylist.ColWidths[1]
                       +gridactplaylist.ColWidths[2]+ps1;
    ...
    if APlText=nil then APlText := TFindImg.Create(imgAPlFindStr.Canvas, 'Исполнитель');
    if APlTime=nil then APlTime := TFindImg.Create(imgAPlFindTime.Canvas, 'Время старта');
    ...
    imgpltlcurr.Repaint;
    if APLCurr=nil then APLCurr := TMyComboBox.Create(imgpltlcurr.Canvas, '');
    ...
    for i:=0 to pnlbtnspl.Count-1 do begin
      pnlbtnspl.Rows[i].BackGround:=ProgrammColor;
      for j:=0 to pnlbtnspl.Rows[i].Count-1 do begin
        pnlbtnspl.Rows[i].Btns[j].Color:=ProgrammColor;
        pnlbtnspl.Rows[i].Btns[j].UpdateColorBitmap(pnlbtnspl.Rows[i].Btns[j].ColorBorder,ProgrammFontColor);
...
begin
  ...
  //Panel1
    ...
    if cmp then initgrid(FGRTemplate.GridImgTemplate, RowGridListGR, FGRTemplate.Panel3.Width);
  end;
end;
...
begin
  with FrMyOptions do begin
    ...
    for i:=0 to btnpnloptions.Count-1 do begin
      btnpnloptions.Rows[i].BackGround:=FormsColor;
      for j:=0 to btnpnloptions.Rows[i].Count-1 do begin
        btnpnloptions.Rows[i].Btns[j].Color:=FormsColor;
        btnpnloptions.Rows[i].Btns[j].UpdateColorBitmap(btnpnloptions.Rows[i].Btns[j].Font.Color,FormsFontColor);
