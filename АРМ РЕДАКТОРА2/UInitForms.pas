...
//Перерисовать панель кнопок Tекст
    ...
    if FileExists(lbPlayerFile.Caption)  then PlayerWindow(pnMovie);
  end;
...
begin
  with Form1 do begin
    ...
    cbPlayLists.Color      := ProgrammColor;
    cbPlayLists.Font.Color := ProgrammFontColor;
    cbPlayLists.Font.Size  := ProgrammFontSize+3;
    cbPlayLists.Font.Name  := ProgrammFontName;
