...
implementation
uses umain, ucommon, ugrid, utimeline;
...
begin
  ...
  try
    ...
    0    : begin
             MySinhro := chltc;
             Form1.sbSinhronization.Caption := 'Внешний тайм-код [LTC]';
           end;
    1    : begin
             MySinhro := chsystem;
             Form1.sbSinhronization.Caption := 'Системное время';
           end;
    2    : begin
             MySinhro := chnone;
             Form1.sbSinhronization.Caption := 'Ручной режим';
           end;
        end;
