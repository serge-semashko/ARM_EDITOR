...
//Панель Пользователей
   ...
   btnspanelusers.Left:=10;
   btnspanelusers.Right:=10;
   btnspanelusers.Top:=60;
   btnspanelusers.Bottom:=0;
   ...
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Hint:='Добавить нового пользователя.';
   ...
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Font.Color:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].ColorBorder:=clWhite;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].Hint:='Удалить пользователя.';
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].HintShow:=true;
   btnspanelusers.Rows[RowTemp].Btns[BtnTemp].FontHint.Size:=8;
