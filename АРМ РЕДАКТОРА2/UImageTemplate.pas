...
begin
  ...
  if CRow=-1 then begin
    ...
    (GridImgTemplate.Objects[0,CRow] as TGridRows).MyCells[1].UpdatePhrase('File',createunicumname + '.jpeg');
    (GridImgTemplate.Objects[0,CRow] as TGridRows).MyCells[2].UpdatePhrase('File',createunicumname + '.jpeg');
