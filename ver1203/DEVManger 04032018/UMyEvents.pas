...
begin
    ...
    begin
        ...
        begin
            if trim(lowercase(Rows[i].Phrases[j].Name)) = trim(lowercase(Name))
            then
            begin
                result.X := i;
                result.Y := j;
    ...
    begin
        ...
        begin
            AddPhrase(rw, Event.Rows[i].Phrases[j].Name,
              ...
              Event.Rows[i].Phrases[j].Maxlength);
            ...
            SetPhraseTag(Event.Rows[i].Phrases[j].Name,
              Event.Rows[i].Phrases[j].Tag);
        ...
        begin
            ...
            begin
                ...
                if trim(Rows[i].Phrases[j].Text) <> '' then
                    ...
                    zn := bmp.Canvas.TextWidth
                      (mystr('0', Rows[i].Phrases[j].Maxlength));
