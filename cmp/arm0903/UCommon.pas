...
begin
  ...
  begin
     ...
     if str1 <> str2  then showmessage('!error retrieve '+'TLO['+IntToStr(i)+']');
  end;
     str1:=TLParameters.SaveToJSONStr;
     PutJsonStrToServer('TLP',str1);
     str2 := GetJsonStrFromServer('TLP');
     if str1 <> str2  then showmessage('!error retrieve '+'TLineparameters');
  ...
  begin
     ...
     if str1 <> str2  then showmessage('!error retrieve '+'TLT['+IntToStr(i)+']');
  end;
